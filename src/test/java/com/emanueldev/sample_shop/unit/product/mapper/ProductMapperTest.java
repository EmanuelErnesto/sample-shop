...
public class ProductMapperTest {
    ...
    void testMappingFromProductPageToPaginatedProductDTO_ShouldReturnPaginatedProductDTOObject() {
        ...
        assertEquals(productResponseDTOList.get(0).getProductId(), paginatedProductResponseDTO.getProducts().get(0).getProductId());
        ...
        assertEquals(productResponseDTOList.get(1).getProductId(), paginatedProductResponseDTO.getProducts().get(1).getProductId());
